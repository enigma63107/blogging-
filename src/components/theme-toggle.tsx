...
export function ThemeToggle() {
  ...
  // The server has no idea which theme the visitor prefers, so we render a
  // fixed-size placeholder until hydration rather than flashing the wrong icon.
  ...
  return (
    ...
    >
      {!mounted ? (
        ...
        <svg viewBox="0 0 24 24" className="size-[18px]" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round">
